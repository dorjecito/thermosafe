        ...
        <>
          ...
          {day && (
            ...
            />
              ...
              {/* 🧠 Missatge contextual UV */}
              
              {contextualUVMessage && (
                <div
                  className={`uv-context-card ${
                    (uvi ?? 0) >= 11 ? "uv-context-card--warning" : "uv-context-card--info"
                  }`}
                >
                  <span className="uv-context-icon">🧠</span>
                  <span className="uv-context-text">{contextualUVMessage}</span>
                </div>
              )}
